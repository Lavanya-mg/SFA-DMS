{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'sfa_expense_v19/static/src/css/expense_policy_manager.css',
            'sfa_expense_v19/static/src/js/expense_policy_manager.js',
            'sfa_expense_v19/static/src/xml/expense_policy_manager.xml',
        ],
    },
    'installable': True,
    'auto_install': False,
